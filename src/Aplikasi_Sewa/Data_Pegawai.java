...
public class Data_Pegawai extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        intan_tfbagian = new javax.swing.JTextField();
        ...
        intan_tabel.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Pegawai", "Nama Pegawai", "Alamat", "Bagian", "Kontak"
            }
        ));
        ...
        jLabel6.setText("Kontak Pegawai");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addComponent(intan_tfbagian, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(intan_tfbagian, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(26, 26, 26)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel1.setBounds(0, 0, 974, 920);

        setSize(new java.awt.Dimension(991, 932));
    ...
    private void intan_tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_intan_tabelMouseClicked
        ...
        intan_tfbagian.setText(intan_tabel.getValueAt(row, 3).toString());
    ...
    private void intan_cariActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_intan_cariActionPerformed
        ...
        try {
            String query = "SELECT * FROM data_pegawai where id_pegawai = '" + intan_tfcari.getText() + "'";
            Statement st = db.getKoneksi().createStatement();
            ResultSet rs = st.executeQuery(query);
            while (rs.next()) {
                intan_tfid.setText(rs.getString("id_pegawai"));
                intan_tfnama.setText(rs.getString("nama_pegawai"));
                intan_alamat.setText(rs.getString("alamat_pegawai"));
                intan_tfbagian.setText(rs.getString("Bagian"));
                intan_tfkontak.setText(rs.getString("kontak_pegawai"));
            }
        }
        catch (SQLException e)
        {
    ...
    private void intan_updateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_intan_updateActionPerformed
        ...
        try {
            String sql = "update data_pegawai SET id_pegawai ='"+ intan_tfid.getText()+
            "',nama_pegawai = '" + intan_tfnama.getText()+
            "',jenis_kelamin = '"+jekel+
            "',alamat_pegawai = '" + intan_alamat.getText()+
            "',Bagian = '" + intan_tfbagian.getText()+
            "',kontak_pegawai = '" + intan_tfkontak.getText()+
            "' WHERE id_pegawai = '"+intan_tfid.getText()+
            "'";
            Statement st = db.getKoneksi().createStatement();
    ...
    private void intan_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_intan_deleteActionPerformed
        ...
        if (ok==0)
        {
            try
            {
                String sql = "Delete FROM data_pegawai where id_pegawai  = '" + intan_tfid.getText() + "'";
                Statement st = db.getKoneksi().createStatement();
                st.executeUpdate(sql);
    ...
    private void intan_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_intan_saveActionPerformed
        ...
        // kode Simpan---------------
        String sql = "Insert Into data_pegawai Values ('" + intan_tfid.getText() +
        "',  '" + intan_tfnama.getText() +
        "','" + jekel +
        "','" + intan_alamat.getText() +
        "','" + intan_tfbagian.getText() +
    ...
    private javax.swing.JTextField intan_tfbagian;
